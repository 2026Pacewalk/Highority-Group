      ...
      <div className="container-main relative z-10 pt-16 pb-24 md:pb-8">
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            className="group w-10 h-10 rounded-lg flex items-center justify-center text-[#7A8CA5] bg-white/5 border border-white/10 hover:text-[#0A1628] hover:bg-[#00D4FF] hover:border-[#00D4FF] transition-all duration-300"
          >
